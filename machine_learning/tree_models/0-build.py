#!/usr/bin/env python3
"""
This module creates a decision tree classifier using Scikit-learn.
"""
...
def build_decision_tree(min_samples_leaf, min_samples_split, random_state):
    ...
    The decision tree uses the Gini impurity measure to evaluate
    the quality of splits.
    No maximum depth is set, allowing the tree to grow until all
    leaves are pure or other stopping criteria are met.
