#!/usr/bin/env python3
"""
This module  trains multiple decision tree classifiers over a range of
...
def prune_and_evaluate_trees(X_train, y_train, X_test, y_test, ccp_alphas,
    ...
    This function helps analyze how different pruning strengths affect
    model complexity and performance.

    Args:
        X_train, y_train: Training data and labels.
        X_test, y_test: Testing data and labels.
        ccp_alphas: A NumPy array of pruning alpha values
                    to use for training different trees.
